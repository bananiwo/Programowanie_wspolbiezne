...
namespace Data
{
    internal class DataApi : DataAbstractApi
    {
        ...
        private readonly BallLoggerApi ballLogger = new BallLogger();
            ...
            if (count > 0)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    IBall ball = new Ball(i + 1 + ballsCount, 
                        ...
                        new System.Numerics.Vector2((float)(random.Next(-10, 10) + random.NextDouble()),(float)(random.Next(-10, 10) + random.NextDouble())), (BallLogger)ballLogger);
